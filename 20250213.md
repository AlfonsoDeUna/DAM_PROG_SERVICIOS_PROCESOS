...
Descripción: Implementa un servidor que funcione como un juego de preguntas y respuestas. El servidor debe enviar preguntas a los clientes y verificar sus respuestas.

Requisitos:

* El servidor debe tener una lista de preguntas y respuestas predefinidas.
* Cada cliente debe recibir una pregunta y enviar una respuesta.
* El servidor debe llevar un registro de la puntuación de cada cliente.
...
### Ejercicio sencillo básico
* Servidor con ECO

### ejercicio de examen 
* Escribe un servidor que acepte conexiones de múltiples clientes. Cada cliente debe enviar su nombre, y el servidor debe responder con un mensaje personalizado (por ejemplo, "Hola, [nombre]").
